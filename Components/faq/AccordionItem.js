...
const AccordionItem = () => {
  const data = [
    ...
    },
    {
      ...
      description: `• 9,996. 999 of these will be the powerful Dark Samsar warriors!
      `,
    },
    {
      title: `Number of Gen1 mints available`,
      description: `• 18,000. 1,800 of these will be Dark Samsar reinforcements.
      `,
    },
    {
    ...
    },
    {
      ...
      description: `• On top of your regular staking rewards, if you have won the most fights that week, then you will be rewarded with an extra prize of 100k $HONR!
      `,
    },
    {
